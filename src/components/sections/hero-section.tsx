...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    gsap.set([".hero-title", ".hero-subtitle", ".scroll-indicator"], {
      opacity: 1,
    });
    ...
    >
      ...
      >
        ...
        <div className="flex justify-center space-x-4 hero-buttons">
          <Button onClick={scrollToCategories} variant="primary">
            Explorar trabalhos
          </Button>
        </div>
      </div>
      ...
      <div
        ...
        className="scroll-indicator absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center  opacity-100"
      >
